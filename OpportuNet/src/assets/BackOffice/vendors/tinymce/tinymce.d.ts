...
declare type DialogActionHandler<T extends DialogData = DialogData> = (api: DialogInstanceApi<T>, details: DialogActionDetails) => void;
declare type DialogChangeHandler<T extends DialogData = DialogData> = (api: DialogInstanceApi<T>, details: DialogChangeDetails<T>) => void;
declare type DialogSubmitHandler<T extends DialogData = DialogData> = (api: DialogInstanceApi<T>) => void;
declare type DialogCloseHandler = () => void;
declare type DialogCancelHandler<T extends DialogData = DialogData> = (api: DialogInstanceApi<T>) => void;
declare type DialogTabChangeHandler<T extends DialogData = DialogData> = (api: DialogInstanceApi<T>, details: DialogTabChangeDetails) => void;
...
type PublicDialog_d_DialogSpec<_0 extends DialogData = DialogData> = DialogSpec<_0>;
type PublicDialog_d_DialogInstanceApi<_0 extends DialogData = DialogData> = DialogInstanceApi<_0>;
...
declare type InstanceApi<T extends DialogData = DialogData> = UrlDialogInstanceApi | DialogInstanceApi<T>;
